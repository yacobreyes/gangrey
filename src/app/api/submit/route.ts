...
export async function POST(req: Request) {
  ...
  const from = process.env.SUBMISSIONS_FROM ?? "The Sunland Tribune <submissions@gangrey.org>";
  if (apiKey) {
    try {
      ...
      await resend.emails.send({ from, to: [email], subject: "We received your Sunland Tribune submission", html });
    } catch (e) {
