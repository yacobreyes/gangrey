                          ...
                          return (
                            <>
                              {sortedNl.map(n => row({
                                ...
                                title: n.subject || <span style={{ fontFamily: FONT, fontWeight: 400, color: TEXT_MUTED }}>Untitled newsletter</span>,
                              ...
                              {sortedPosts.map(post => row({
                                ...
                                title: post.headline || <span style={{ fontFamily: FONT, fontWeight: 400, color: TEXT_MUTED }}>No headline</span>,
