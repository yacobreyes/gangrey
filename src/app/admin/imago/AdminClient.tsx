...
const PANEL_TITLES: Partial<Record<Panel, string>> = {
  ...
  archive: "Archive", analytics: "Analytics", calendar: "Calendar", scoop: "Scoop",
};
          ...
          <div style={{ flex: 1, padding: "0.35rem 0.7rem", overflowY: "auto", overflowX: "hidden" }}>
            {([
              ...
              ["Newsroom", null, [
                ...
                ["scoop", "Scoop", <svg key="sc" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>],
              ]],
            ...
            <div>
              ...
              <div style={{ background: "white", border: `1px solid ${CARD_LINE}`, borderRadius: 14, overflow: "hidden" }}>
                {([
                  ...
                  ["scoop", "Scoop", <svg key="sc" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>],
                  ...(isAdmin ? [
