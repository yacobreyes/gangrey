...
type Panel = "dashboard" | "media" | "comments" | "about" | "subscribers" | "users" | "analytics";
const VALID_PANELS: Panel[] = ["dashboard", "media", "comments", "about", "subscribers", "users", "analytics"];
