...
type Panel = "dashboard" | "media" | "comments" | "about" | "subscribers" | "users" | "analytics" | "submissions" | "archive" | "members" | "more";
const VALID_PANELS: Panel[] = ["dashboard", "media", "comments", "about", "subscribers", "users", "analytics", "submissions", "archive", "members", "more"];
