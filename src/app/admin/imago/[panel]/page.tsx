...
type Panel = "dashboard" | "media" | "comments" | "about" | "subscribers" | "users" | "analytics" | "leads" | "submissions" | "members" | "more" | "calendar";
const VALID_PANELS: Panel[] = ["dashboard", "media", "comments", "about", "subscribers", "users", "analytics", "leads", "submissions", "members", "more", "calendar"];
