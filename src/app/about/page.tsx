      ...
      <main className="about-main">
        ...
        <div className="about-cols">
          ...
          <div className="about-col-right">
            ...
            <p className="about-rights">Authors retain copyright to their work. For each accepted piece, we provide a one-year membership and an honorarium: $45 for reported narratives and essays, $25 for micro-memoirs.</p>
            <p className="about-rights">In accepting publication, the author grants us first serial rights and the nonexclusive right to archive and promote the work.</p>
