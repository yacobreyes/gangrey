    ...
    <tr><td align="center" style="padding:36px 16px;">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:480px;background-color:#ffffff;border:1px solid ${RULE};border-collapse:collapse;">
        <tr><td style="padding:32px 34px 8px;text-align:center;">
          <img src="${SITE_URL}/Wordmark.png?v=10" alt="The Sunland Tribune" width="260" style="width:260px;max-width:80%;display:block;margin:0 auto 16px;border:0;" />
      ...
      <p style="font-family:${SANS};font-size:10px;letter-spacing:.14em;text-transform:uppercase;color:#8a8a8c;text-align:center;margin:20px 0 0;">The Sunland Tribune &middot; A Literary Magazine</p>
    </td></tr>
  </table>
</body></html>`;
}
